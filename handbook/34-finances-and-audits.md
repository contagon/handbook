...
* He ensures that the stake complies with all applicable tax laws (see [34.10]). He also participates in periodic audits by stake auditors and takes corrective actions if needed (see [34.9]).

For information about calling stake clerks and assistant stake clerks, see [33.3.2] and [33.3.3].
...
For information about calling ward clerks and assistant ward clerks, see [33.4.2] and [33.4.3].
...
Guidelines for using fast-offering funds are provided in [22.2.4].
...
For additional information about missionary funds and financing missionary service, see [24.6].
...
For more information about the Perpetual Education Fund, see [22.6.4.7].
...
Possible exceptions to the funding policy in the preceding paragraph may be made for annual camps or similar activities (see [20.2.8]), optional activities (see [20.5]), and occasional young single adult activities (see [14.3.7]).

...
Where there are not enough members in one of these circumstances to create a separate branch, a stake president may propose creating a group (see [37.7]).
...
A mission president may propose creating a language branch or group to address these same circumstances (see [36.3] and [37.7]).
...
The children and youth of a language unit may combine classes with a geographic unit if desired (see [29.2.8]).
...
For instructions on creating wards, branches, and service member groups that meet on military installations, see [38.9.4].